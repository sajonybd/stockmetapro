    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-4 flex flex-col gap-2">
          ...
          <Link href="/admin/packages" className="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-colors font-medium">
            Manage Packages
          </Link>
          <Link href="/admin/payments" className="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-colors font-medium">
            Manage Payments
          </Link>
          <Link href="/admin/payment-history" className="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-colors font-medium text-emerald-600">
            Payment History
          </Link>
          ...
          <Link href="/admin/api-logs" className="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-colors font-medium text-purple-600">
            API Request Logs
          </Link>
          <Link href="/admin/software-errors" className="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-colors font-medium text-red-600">
            Software Error Logs
          </Link>
